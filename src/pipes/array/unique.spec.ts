...
describe("DiffPipe", () => {
  ...
  it("should filter the array based on object properties when a property name is supplied in arguments", () => {
    ...
    expect(pipe.transform([1, 2, { a: 1, b: true }, { a: 3, b: false }], "b")).toEqual([
      { a: 1, b: true },
      { a: 3, b: false },
    ]);
  ...
  it("should filter the array based on object deep properties when a property name dot separated is supplied in arguments", () => {
    expect(
      pipe.transform([{ b: { c: { d: true } } }, { b: { c: { d: false } } }, { b: { c: { d: true } } }], "b.c.d")
    ).toEqual([{ b: { c: { d: true } } }, { b: { c: { d: false } } }]);
    expect(pipe.transform([1, 2, { b: { c: { d: true } } }, { b: { c: { d: false } } }], "b.c.d")).toEqual([
      { b: { c: { d: true } } },
      { b: { c: { d: false } } },
    ]);
    expect(pipe.transform([{ b: { c: { d: true } } }, { b: { c: { d: false } } }], "b.c")).toEqual([
      { b: { c: { d: true } } },
      { b: { c: { d: false } } },
    ]);
