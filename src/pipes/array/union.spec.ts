...
describe('UnionPipe', () => {
  ...
  it('should union two arrays with duplicate values, and remove the intersection', () => {
    ...
    expect(pipe.transform([1, 2, 3, 4], [[1, 2, 3, 5]])).toEqual([
      1,
      2,
      3,
      4,
    ...
    expect(pipe.transform([1, 2, 3], [[1, 2, 3, 4, 5, 6]])).toEqual([
      1,
      2,
      3,
      4,
  ...
  it('should union multiple arrays with duplicate values, and remove the intersection', () => {
    ...
    expect(pipe.transform([1, 2, 3, 4], [[1, 2, 3], [5, 6]])).toEqual([
      1,
      2,
      3,
      4,
    ...
    expect(pipe.transform([1, 2, 3, 4], [[1, 2, 3, 5], [5, 6]])).toEqual([
      1,
      2,
      3,
      4,
