...
describe('ScanPipe Tests', () => {
  ...
  it('should switch the variables properly', () => {
    ...
    expect(pipe.transform('Lorem ipsum {0}{0} sit amet {0}{1}', ['foo', 'bar'])).toEqual(
      'Lorem ipsum foofoo sit amet foobar'
    );
  });

  it('should keep missing variables', () => {
    expect(pipe.transform('Lorem ipsum {0} sit amet {1}{2}', ['foo', 'bar'])).toEqual(
      'Lorem ipsum foo sit amet bar{2}'
    );
    expect(pipe.transform('Lorem ipsum {1} sit amet {0}{2}{3}', ['foo', 'bar'])).toEqual(
      'Lorem ipsum bar sit amet foo{2}{3}'
    );
  });
});
